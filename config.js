...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("242068312525")
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://sam:sam@cluster0.u1smxsv.mongodb.net/?retryWrites=true&w=majority"
global.port= process.env.PORT || 5000
global.email = 'lordbgpo@gmail.com'
global.github = 'https://github.com/Equal-Heaven/FORZEN-MD'
...
global.website = 'https://github.com/Equal-Heaven/FORZEN-MD' //wa.me/+242068312525
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '𝔹ℝ𝕐𝔸ℕ' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '𝕎𝔼𝕀ℝ𝔻 𝕋𝔼𝔸𝕄' : process.env.PACK_INFO.split(";")[0],
